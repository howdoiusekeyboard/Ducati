...
async function uploadMediaFiles() {
  try {
    ...
    console.log('   - https://ducati-mvp.firebasestorage.app/o/icons8-money-96.png?alt=media');
    console.log('   - https://ducati-mvp.firebasestorage.app/o/og-image.png?alt=media');
