...
const ErrorDisplay: React.FC<ErrorDisplayProps> = ({ error, onClear, onRetry }) => {
  ...
  return (
    <div className="mx-6 mt-4">
      <div
        className={`${config.bgColor} animate-fadeIn rounded-lg border border-red-200 p-4`}
        role="alert"
        aria-live="polite"
      >
        <div className="flex items-start justify-between">
          <div className="flex">
            ...
            <div className="ml-3 flex-1">
              ...
              {config.showRetry && (
                <button
                  onClick={onRetry}
                  className="bg-danger mt-3 inline-flex items-center gap-1 rounded-md px-3 py-1 text-xs font-medium text-white transition-colors hover:bg-red-600"
          ...
          <button
            onClick={onClear}
            className="text-text-light hover:text-danger rounded-md p-1 transition-colors hover:bg-red-50"
